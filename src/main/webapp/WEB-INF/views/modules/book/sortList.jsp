...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/book/sort/">产品列表</a></li>
		<shiro:hasPermission name="book:sort:edit"><li><a href="${ctx}/book/sort/form">产品添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="sort">
			<tr>
				...
				<shiro:hasPermission name="book:sort:edit"><td>
					...
					<a href="${ctx}/book/sort/delete?id=${sort.id}" onclick="return confirmx('确认要删除该产品吗？', this.href)">删除</a>
