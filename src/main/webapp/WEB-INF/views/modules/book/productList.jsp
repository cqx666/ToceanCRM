		...
		<ul class="ul-form">
			...
			<li><label>归属类别：</label>
				<sys:treeselect id="sort" name="sort.id" value="${product.sort.id}" labelName="sort.name" labelValue="${product.sort.name}"
								title="类别" url="/book/sort/listall" cssClass="input-small" allowClear="true" notAllowSelectParent="true"/>
			</li>
		...
		<c:forEach items="${page.list}" var="product">
			<tr>
				...
				<shiro:hasPermission name="book:product:edit"><td>
					...
					<a href="${ctx}/book/product/delete?id=${product.id}" onclick="return confirmx('确认要删除该产品吗？', this.href)">删除</a>
