...
<body>
	...
	<form:form id="inputForm" modelAttribute="studentDiscuss" action="${ctx}/student/studentDiscuss/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">createrid：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">pm_id：</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="group.Id" htmlEscape="false" maxlength="20" class="input-xlarge  digits"/>
			</div>
		</div>
