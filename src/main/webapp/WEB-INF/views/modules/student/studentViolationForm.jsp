...
<body>
	...
	<form:form id="inputForm" modelAttribute="studentViolation" action="${ctx}/student/studentViolation/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">studentattitude：</label>
			<div class="controls">
