...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/student/studentViolation/">违纪列表</a></li>
		<shiro:hasPermission name="student:studentViolation:edit"><li><a href="${ctx}/student/studentViolation/form">违纪添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="studentViolation" action="${ctx}/student/studentViolation/" method="post" class="breadcrumb form-search">
