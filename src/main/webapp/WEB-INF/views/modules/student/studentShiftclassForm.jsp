...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/student/studentShiftclass/">变更列表</a></li>
		<li class="active"><a href="${ctx}/student/studentShiftclass/form?id=${studentShiftclass.id}">变更<shiro:hasPermission name="student:studentShiftclass:edit">${not empty studentShiftclass.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="student:studentShiftclass:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="studentShiftclass" action="${ctx}/student/studentShiftclass/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">shiftdate：</label>
			<div class="controls">
