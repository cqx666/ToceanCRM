...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/student/studentShiftclass/">变更列表</a></li>
		<shiro:hasPermission name="student:studentShiftclass:edit"><li><a href="${ctx}/student/studentShiftclass/form">变更添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="studentShiftclass">
			<tr>
				<shiro:hasPermission name="student:studentShiftclass:edit"><td>
					...
					<a href="${ctx}/student/studentShiftclass/delete?id=${studentShiftclass.id}" onclick="return confirmx('确认要删除该变更吗？', this.href)">删除</a>
