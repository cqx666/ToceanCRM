...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/student/studentProjectpoll/">考核列表</a></li>
		<shiro:hasPermission name="student:studentProjectpoll:edit"><li><a href="${ctx}/student/studentProjectpoll/form">考核添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="studentProjectpoll">
			<tr>
				<shiro:hasPermission name="student:studentProjectpoll:edit"><td>
					...
					<a href="${ctx}/student/studentProjectpoll/delete?id=${studentProjectpoll.id}" onclick="return confirmx('确认要删除该考核吗？', this.href)">删除</a>
