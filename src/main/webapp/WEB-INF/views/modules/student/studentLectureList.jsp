...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/student/studentLecture/">演讲列表</a></li>
		<shiro:hasPermission name="student:studentLecture:edit"><li><a href="${ctx}/student/studentLecture/form">演讲添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="studentLecture">
			<tr>
				...
				<shiro:hasPermission name="student:studentLecture:edit"><td>
    				<a href="${ctx}/student/studentLecture/form?id=${studentLecture.id}">修改</a>
