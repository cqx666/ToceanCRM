...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/student/studentHomework/">作业布置列表</a></li>
		<shiro:hasPermission name="student:studentHomework:edit"><li><a href="${ctx}/student/studentHomework/form">作业布置添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="studentHomework">
			<tr>
				...
				<shiro:hasPermission name="student:studentHomework:edit"><td>
					...
					<a href="${ctx}/student/studentHomework/delete?id=${studentHomework.id}" onclick="return confirmx('确认要删除该作业布置吗？', this.href)">删除</a>
