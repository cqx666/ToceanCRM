...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/student/studentAttendance/">用户列表</a></li>
		<shiro:hasPermission name="student:studentAttendance:edit"><li><a href="${ctx}/student/studentAttendance/form">用户添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="studentAttendance">
			<tr>
				...
				<shiro:hasPermission name="student:studentAttendance:edit"><td>
					...
					<a href="${ctx}/student/studentAttendance/delete?id=${studentAttendance.id}" onclick="return confirmx('确认要删除该用户吗？', this.href)">删除</a>
